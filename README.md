...
This repository contains the pipeline for fine-tuning **SmolVLM2-2.2B-Instruct** on the **Kvasir-VQA dataset**[View the Finetuning Notebook (PDF)](./SmolVLM_Finetuning_Notebook.pdf).  
